...
struct SettingsView: View {
        ...
        Section {
            ...
            Text("""
                ...
                **modify** devices in your tenant, not just read them — your administrator \
                ...
                Leaving it off means PitLAPS only ever requests read access.
                """)
        }
    }
    ...
    private var macOSSection: some View {
        Section {
            ...
            Text("""
                ...
                service, and only the admin center can display them. PitLAPS will enable \
    ...
    private var aboutSection: some View {
        Section("About") {
            ...
            Link("Source code", destination: URL(string: "https://github.com/Kainor-LLC/PitLAPS")!)
            Text("PitLAPS is not affiliated with, endorsed by, or sponsored by Microsoft Corporation.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
